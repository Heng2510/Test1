...
<body>
    ...
    <!-- start latest -->
    <div class="latest container mt-4 mt-sm-5">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="font-weight-bolder float-left">Latest Manga Updates</h2>
            </div>
            <div class="col-lg-6">
...
<%--            List--%>
            <div class="col-lg-2 col-md-3 col-sm-4">
                <div class="card mb-3">
                    <a href="details.jsp"><img src="img/cover1.jpg" class="card-img-top" alt=""></a>
...
<%--                        </div>--%>
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a href="details.jsp">One Piece</a></h5>
    ...
    <footer>
        <div class="container py-4">
            <span class="copyright">&copy; 2022 SE1603</span>
            <span class="design float-right">Designed by Canh Kho Qua</span>
        </div>
    </footer>
    <!-- end footer -->
